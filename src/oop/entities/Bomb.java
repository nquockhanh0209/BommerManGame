            ...
            if(ani.aniDone()) {
                ...
                if(!flameIsCreate) {
                    ...
                    if(!Game.getBlockType(x-1, y).equals("class oop.entities.Wall")) {
                        ...
                        if(!Game.getBlockType(x - 2, y).equals("class oop.entities.Wall") &&  Game.flameblock == 2) {
                    ...
                    if(!Game.getBlockType(x+1, y).equals("class oop.entities.Wall")) {
                        ...
                        if(!Game.getBlockType(x + 2, y).equals("class oop.entities.Wall") &&  Game.flameblock == 2) {
                            Entity flame12 = new Flame(x + 2, y, Sprite.explosion_horizontal.getFxImage(), flameh2);
                    ...
                    if(!Game.getBlockType(x, y-1).equals("class oop.entities.Wall")) {
                        ...
                        if(!Game.getBlockType(x, y - 2).equals("class oop.entities.Wall") &&  Game.flameblock == 2) {
